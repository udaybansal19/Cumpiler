...
module.exports.compileCPlusPlus = function(id) {
...
module.exports.compileC = function(id) {

  return new Promise( (resolve, reject) => {
    const gPlus = spawn('g++', ['./codeFiles/' + id + '.c', '-o', './executables/' + id + '.exe']);
    console.log("G++ running...");
